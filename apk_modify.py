# with open("D:\\work\\apk\\matchDemoDot7.txt", "r") as f:
#     lines = f.readlines()
#     # print(lines)
# # 修改不合理数据
# with open("D:\\work\\apk\\matchDemoModifyDot7.txt", "w") as f_w:
#     for line in lines:
...
# 清洗出未匹配到数据
with open("D:\\work\\apk\\matchDemoModifyDot7.txt", "r") as f:
    lines_1 = f.readlines()
    # print(lines_1)
with open("D:\\work\\apk\\xenderDemo.txt", "r") as ff:
    lines_2 = ff.readlines()
    # print(lines_2)
with open("D:\\work\\apk\\matchDemoRestDot7.txt", "w") as f_w:
